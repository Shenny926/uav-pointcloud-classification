...
output_path = r"E:\shenj\Documents\test_set_2026\PhotoLab_Group1_2026_classified_v3.laz"
...
if hasattr(las, "red"):
    ...
    rgb = np.zeros((n_points, 3), dtype=np.float64)
...
# ---- Step 2: Geometric features + local relative greenness ----
print("\nComputing geometric features + local relative greenness...")
t0 = time.time()
...
local_greenness = np.zeros(n_points)
...
print("\nLoading trained classifier (v3, local relative greenness)...")
